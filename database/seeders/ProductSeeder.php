...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::create([
            ...
            'category' => 'furniture',
            'production_cost' => 18000.00,
            'selling_price' => 21600.00,
            'current_stock' => 4,
            'minimum_stock' => 1,
            'unit' => 'piece',
        ]);
        ...
        Product::create([
            ...
            'category' => 'cabinets',
            'production_cost' => 34000.00,
            'selling_price' => 40800.00,
            'current_stock' => 3,
            'minimum_stock' => 1,
            'unit' => 'piece',
        ]);
        ...
        Product::create([
            ...
            'category' => 'cabinets',
            'production_cost' => 22000.00,
            'selling_price' => 26400.00,
            'current_stock' => 3,
            'minimum_stock' => 1,
            'unit' => 'piece',
        ]);
        ...
        Product::create([
            ...
            'category' => 'cabinets',
            'production_cost' => 42000.00,
            'selling_price' => 50400.00,
            'current_stock' => 1,
            'minimum_stock' => 1,
            'unit' => 'piece',
        ]);
