	...
	<div class="flex h-screen bg-gray-100">
		...
		<div class="w-64 bg-slate-700 text-white flex flex-col">
			...
			<nav class="flex-1 p-4">
				<ul class="space-y-2">
					<li>
						<a href="#" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-orange-500 text-white">
					...
					<li>
						<a href="{{ route('inventory') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 hover:bg-slate-600 hover:text-white transition">
							<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
					...
					<li>
						<a href="{{ route('sales-orders.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg text-slate-300 hover:bg-slate-600 hover:text-white transition">
							<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
