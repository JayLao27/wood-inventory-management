			...
			<div class="flex-1 p-8 bg-amber-50 overflow-y-auto">
				...
				<section class="bg-slate-700 text-white p-6 rounded-2xl">
					...
					<div class="flex justify-center gap-2 mb-6">
						<button id="salesTab" class="px-[240px] py-2 rounded-lg" style="background-color: #FFF1DA; color: #111827;">SalesOrders</button>
						<button id="customersTab" class="px-[240px] py-2 rounded-lg border" style="background-color: #374151; border: 1px solid #FFFFFF; color: #FFFFFF;">Customers</button>
					</div>
