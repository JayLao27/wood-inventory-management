    ...
    <div class="flex-1 p-8 bg-amber-50">
        ...
        <div class="bg-slate-700 rounded-lg p-6">
            ...
            <div class="flex space-x-1 mb-6">
                <button onclick="showTab('purchase-orders')" id="purchase-orders-tab" class="px-[270px] py-2 rounded-lg" style="background-color: #FFF1DA; color: #111827;">Purchase Orders</button>
                <button onclick="showTab('suppliers')" id="suppliers-tab" class="px-[270px] py-2 rounded-lg border" style="background-color: #374151; border: 1px solid #FFFFFF; color: #FFFFFF;">Suppliers</button>
            </div>
